    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &LINGAOBASE::velCallback, this);
}

void LINGAOBASE::velCallback(const lingao_msgs::Velocities& vel)
{
